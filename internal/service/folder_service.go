...
func NewFolderService(folderRepo domain.FolderRepository, userRepo domain.UserRepository) *FolderService {
...
// Delete soft-deletes a folder and all its descendant folders (trash).
